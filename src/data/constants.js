export const Bio = {
  ...
  description:
    "Creative MERN stack and React.js front-end developer. I build high-performance, responsive web apps that deliver seamless user experiences, turning innovative ideas into functional digital solutions",
